 ...
 * The class needs to have one contructor with three parameters width, length, and height all of type double.
 * It needs to call the parent constructor and initialize a height field.
 * In case the height parameter is less than 0 it needs to set height field value to 0.
